...
/** Черновик формирования документов на экспорт — описательные метаданные
    (какие поля заполнены, как разрезан PDF на страницы и т.п.), БЕЗ
    содержимого самих файлов. При восстановлении черновика файлы нужно
    заново перетащить/выбрать — тот же обработчик выбора файлов узнаёт их
    по имени и подхватывает сохранённые настройки автоматически (см.
    processSingleFiles в single.js и processGroupFile в group.js).
    Черновик может быть только один на папку — сохранение всегда
